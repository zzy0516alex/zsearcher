package com.Z.NovelReader.zxing.activity;
...
import com.Z.NovelReader.Utils.QRcodeUtils.BitmapUtil;
import com.Z.NovelReader.Utils.QRcodeUtils.Constant;
import com.Z.NovelReader.zxing.camera.CameraManager;
import com.Z.NovelReader.zxing.decoding.CaptureActivityHandler;
import com.Z.NovelReader.zxing.decoding.InactivityTimer;
import com.Z.NovelReader.zxing.decoding.RGBLuminanceSource;
import com.Z.NovelReader.zxing.view.ViewfinderView;
...
//            Logger.d("saomiao",resultString);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler(activity, decodeFormats,
                    characterSet);
        }
    }
