...
//        int action = MotionEventCompat.getActionMasked(e);
        switch (action) {
            case MotionEvent.ACTION_POINTER_DOWN:
                Log.d("drag_touch", "onInterceptTouchEvent ACTION_POINTER_DOWN");
            case MotionEvent.ACTION_DOWN:
                Log.d("drag_touch", "onInterceptTouchEvent ACTION_DOWN");
                reset();
                break;
        }
        recyclerView = rv;
    ...
    public void startAutoScroll() {
        ...
        if (scroller.isFinished()) {
            ...
            recyclerView.postOnAnimation(scrollRun);
        }
    }
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE:
                if (!inTopSpot && !inBottomSpot) {
                    ...
                    //Log.d("drag_touch", "onTouchEvent MOVING");
                }
                //在顶部或者底部触发自动滑动
                processAutoScroll(e);
                break;
